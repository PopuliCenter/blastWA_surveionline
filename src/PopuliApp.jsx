...
function LoginPage({ onLogin }) {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: `linear-gradient(135deg, ${theme.primarySoft} 0%, ${theme.bg} 60%)`,
        display: "flex",
    ...
    >
      <div style={{ ...card, width: "100%", maxWidth: 410, padding: "36px 32px 28px" }}>
        ...
        >
          © 2026 Populi Center · v1.0.0
          <br />
          <span onClick={() => setLegal("privacy")} style={{ color: theme.primary, cursor: "pointer" }}>
            Kebijakan Privasi
          </span>
          {" · "}
          <span onClick={() => setLegal("terms")} style={{ color: theme.primary, cursor: "pointer" }}>
            Syarat &amp; Ketentuan
          </span>
        </div>
      </div>
    ...
    <aside style={asideStyle}>
      <div
        style={{
          ...
          alignItems: "center",
          gap: 10,
          padding: mini ? "0 0 16px" : "0 8px 18px",
      ...
      >
        ...
        {!mobile ? (
          <button
            ...
            aria-label={mini ? "Buka sidebar" : "Tutup sidebar"}
            title={mini ? "Buka sidebar" : "Tutup sidebar"}
            style={{
          ...
          return (
            <div key={sec.group} style={{ marginBottom: mini ? 8 : 14 }}>
              {!mini ? (
                ...
                <div style={{ height: 1, background: theme.border, margin: "0 6px 8px" }} />
              )}
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        gap: 11,
                        width: "100%",
                        padding: mini ? "11px 0" : "9px 10px",
                        borderRadius: 9,
                        border: "none",
                        background: on ? theme.primarySoft : "transparent",
...
export default function PopuliApp() {
  ...
  useEffect(() => {
    localStorage.setItem("populi.activePage", active);
  }, [active]);
  useEffect(() => {
    localStorage.setItem("populi.sidebarCollapsed", collapsed ? "1" : "0");
  }, [collapsed]);
    ...
    () => ({
      ...
      instagram: (
        <ComingSoon
          title="Instagram"
          icon="instagram"
          desc="Kelola DM & komentar Instagram dalam satu inbox bersama WhatsApp."
      ...
      story: (
        <ComingSoon
          title="WA Story"
          icon="story"
          desc="Posting status/story WhatsApp Business langsung dari dashboard."
          features={["Jadwal story", "Story ke banyak akun"]}
        />
      ),
      surveys: <Surveys />,
      reports: <Reports />,
  ...
  return (
    <div
      style={{ display: "flex", minHeight: "100vh", background: theme.bg, color: theme.text, fontFamily: fontStack }}
    >
      <Sidebar
        active={active}
        setActive={setActive}
      ...
      {ok ? (
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 4 }}>
            ...
            <Button onClick={submit} disabled={!cur || !next || !confirm || saving}>
