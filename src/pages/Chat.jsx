...
import { PageHeader, Card, Button, Notice, Loading, Empty, useLoader, theme, Icon, fmtDate } from "../lib/ui";
  ...
  return (
    <div>
      ...
      <div style={{ ...cardWrap, display: "grid", gridTemplateColumns: "300px 1fr", minHeight: 540 }}>
        <div style={{ borderRight: `1px solid ${theme.border}`, overflow: "auto" }}>
...
function Conversation({ contact }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: 540 }}>
      <div style={{ padding: "13px 16px", borderBottom: `1px solid ${theme.border}`, fontWeight: 600, color: theme.text }}>{contact.name || contact.phone} <span style={{ color: theme.textMuted, fontWeight: 400, fontSize: 12.5 }}>{contact.phone}</span></div>
